...
$lang->msg_do_you_like_install='생성 하시겠습니까?';
...
$lang->skin_fix='스킨 고정';
$lang->about_skin_fix='테마 설정과 상관없이 스킨을 고정시킵니다. 사용하면 테마의 일괄 스킨 설정 대상에서 제외됩니다.';
...
$lang->about_module='XE는 기본 라이브러리를 제외한 나머지는 모두 모듈로 구성되어 있습니다. 모듈 관리 모듈은 설치된 모든 모듈을 보여주고 관리를 돕습니다.';
...
$lang->about_extra_vars_eid_value='확장 변수의 이름을 적어주세요. 영문, 숫자, _를 조합해서 사용할 수 있으며 첫 글자는 영문이어야 합니다.';
...
$lang->multilingual_desc='현재 12 종류의 다국어 문자를 지원할 수 있습니다. 다른 종류의 다국어 지원을 원하는 경우 /common/lang/ 폴더의 다국어 가운데 하나의 세트를 번역해서 XE 개발자(contact@xpressengine.com)에게 보내주세요.';
...
$lang->msg_cannot_delete_startmodule='시작 모듈은 삭제할 수 없습니다.';
