...
$lang->about_layout='레이아웃은 모듈의 겉모습을 꾸며줍니다. 상단 레이아웃 메뉴에서 관리하실 수 있습니다.';
$lang->msg_call_server='서버에 요청 중입니다. 잠시만 기다려주세요.';
$lang->msg_db_not_setted='DB 설정이 되어 있지 않습니다.';
$lang->msg_dbconnect_failed='DB 접속 오류가 발생했습니다.
DB정보를 다시 확인해주세요.';
...
$lang->msg_fail_to_request_open='요청하신 연결에 실패했습니다.';
$lang->msg_invalid_format='잘못된 형식입니다.';
$lang->msg_not_permitted_act='요청하신 기능을 실행할 수 있는 권한이 없습니다.';
$lang->msg_module_is_not_exists='요청하신 모듈을 찾을 수 없습니다. 사이트 관리자에게 모듈 점검 요청 바랍니다';
...
$lang->filter->invalid_mid='%s의 형식이 잘못되었습니다. 첫 글자는 영문으로 시작해야 하며 \'영문+숫자+_\'로만 입력하셔야 합니다.';
