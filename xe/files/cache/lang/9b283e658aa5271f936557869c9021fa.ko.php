...
$lang->install_progress_menu['agree']='라이선스 동의';
...
$lang->install_license_desc['lgpl']='GNU 약소 일반 공중 사용 허가서(LGPL v2)에 동의해야 합니다.';
...
$lang->db_desc['sqlite2']='파일로 데이터를 저장하는 sqlite2를 지원합니다.<br />설치 시 DB파일은 웹에서 접근할 수 없는 곳에 생성하여 주셔야 합니다.<br />(안정화 테스트가 되지 않았습니다.)';
$lang->db_desc['sqlite3_pdo']='PHP의 PDO로 sqlite3를 지원합니다.<br />설치 시 DB파일은 웹에서 접근할 수 없는 곳에 생성하여 주셔야 합니다.';
...
$lang->db_desc['postgresql']='PostgreSql을 이용합니다.';
$lang->db_desc['firebird']='Firebird를 이용합니다.<br />DB 생성 방법 (create database "/path/dbname.fdb" page_size=8192 default character set UTF-8;)';
...
$lang->about_sso='사용자가 한 번만 로그인하면 기본 사이트와 가상 사이트에 동시에 로그인이 됩니다.<br />가상 사이트를 사용할 때만 필요합니다.';
...
$lang->read_all='전문 읽기';
$lang->license_agreement_desc='XE를 사용하려면 <em>이 항목에 반드시 동의해야 합니다</em>.';
$lang->license_agreement_alert='XE를 사용하려면 \'GNU 약소 일반 공중 사용 허가서(LGPL v2)\'에 반드시 동의해야 합니다.';
$lang->install_env_agreement='설치 환경 수집 동의';
$lang->install_env_agreement_desc='\'<em>웹 서버, DBMS, PHP 버전 및 Extension, XE 모듈 및 애드온</em>\' 정보가 XE 통계 수집 서버로 전송됩니다. 더 나은 SW를 제작하기 위한 목적으로 활용합니다. 익명으로 수집되며 이 정보를 외부에 공개하지 않습니다. <em>이 항목에 동의하지 않아도 됩니다.</em>';
