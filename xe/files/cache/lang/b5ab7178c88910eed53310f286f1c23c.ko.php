...
$lang->description_download='FTP를 이용할 수 없는 경우, 직접 다운로드 하여 해당 경로(path)에 설치하셔야 합니다. (한 단계 상위에서 압축을 푸시면 됩니다. ./modules/board의 경우 ./modules에서 묶음(tar)을 푸세요)';
$lang->path='설치경로';
...
$lang->msg_ftp_invalid_auth_info='입력하신 FTP 정보로 로그인을 하지 못했습니다. FTP 정보를 확인해주세요.';
$lang->msg_ftp_not_connected='%s로의 FTP 접속 오류가 발생했습니다. FTP 포트 번호를 확인해주시거나 FTP 서비스가 가능한지 확인해주세요.';
