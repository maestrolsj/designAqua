        ...
        <div class="replyItem <?php if($__Context->comment->get('depth')){ ?>reply<?php } ?>">
            ...
            <div class="replyOption">
                <?php if($__Context->comment->isGranted() || !$__Context->comment->get('member_srl')){ ?>
                    <a href="<?php echo getUrl('act','dispBoardDeleteComment','comment_srl',$__Context->comment->comment_srl) ?>"><img src="/xe/modules/board/skins/xe_board/images/common/buttonDeleteX.gif" alt="<?php echo $__Context->lang->cmd_delete ?>" width="12" height="13" /></a>
                    <a href="<?php echo getUrl('act','dispBoardModifyComment','comment_srl',$__Context->comment->comment_srl) ?>"><img src="/xe/modules/board/skins/xe_board/images/<?php echo $__Context->module_info->colorset ?>/buttonModifyE.gif" alt="<?php echo $__Context->lang->cmd_modify ?>" width="20" height="17" /></a> 
                <?php } ?>
                    <?php if($__Context->oDocument->allowComment()){ ?><a href="<?php echo getUrl('act','dispBoardReplyComment','comment_srl',$__Context->comment->comment_srl) ?>"><img src="/xe/modules/board/skins/xe_board/images/<?php echo $__Context->module_info->colorset ?>/buttonReply.gif" alt="<?php echo $__Context->lang->cmd_reply ?>" width="20" height="17" /></a><?php } ?> 
            </div>
                ...
                <?php if(!$__Context->comment->isAccessible()){ ?>
                    <div class="secretContent">
                        ...
                        <input type="hidden" name="comment_srl" value="<?php echo $__Context->comment->get('comment_srl') ?>" />
                            ...
                            <div class="content"><input type="password" name="password" class="iText" /><span class="btn"><input type="submit" value="<?php echo $__Context->lang->cmd_input ?>" /></span></div>
                        </form>
                    </div>
                <?php }else{ ?>
