...
<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/tpl/js/editor_common.js--><?php $__tmp=array('modules/editor/tpl/js/editor_common.js','','','');Context::loadFile($__tmp,'','','');unset($__tmp); ?><?php } ?>
<?php if(!__DEBUG__){ ?><!--#Meta:modules/editor/tpl/js/editor_common.min.js--><?php $__tmp=array('modules/editor/tpl/js/editor_common.min.js','','','');Context::loadFile($__tmp,'','','');unset($__tmp); ?><?php } ?>
...
<?php if($__Context->colorset == "white_texteditor" || $__Context->colorset == "black_texteditor" || $__Context->colorset == "white_text_nohtml" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "white_text_usehtml" || $__Context->colorset == "black_text_usehtml"){ ?>
	<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor/js/xe_textarea.js--><?php $__tmp=array('modules/editor/skins/xpresseditor/js/xe_textarea.js','','','');Context::loadFile($__tmp,'','','');unset($__tmp); ?><?php } ?>
	<?php if(!__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor/js/xe_textarea.min.js--><?php $__tmp=array('modules/editor/skins/xpresseditor/js/xe_textarea.min.js','','','');Context::loadFile($__tmp,'','','');unset($__tmp); ?><?php } ?>

    <div class="xeTextEditor <?php echo $__Context->editor_class ?>">
        <input type="hidden" id="htm_<?php echo $__Context->editor_sequence ?>" value="<?php if($__Context->colorset == "white_text_nohtml" || $__Context->colorset == "black_text_nohtml"){ ?>n<?php } ?><?php if($__Context->colorset == "white_texteditor" || $__Context->colorset == "white_texteditor"){ ?>br<?php } ?>" />
        <textarea id="editor_<?php echo $__Context->editor_sequence ?>" style="height:<?php echo $__Context->editor_height ?>px;" rows="8" cols="42" class="iTextArea"></textarea>
    </div>
...
<?php }else{ ?>
	...
	<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor/js/Xpress_Editor.js--><?php $__tmp=array('modules/editor/skins/xpresseditor/js/Xpress_Editor.js','','','');Context::loadFile($__tmp,'','','');unset($__tmp); ?><?php } ?>
	<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor/js/xe_interface.js--><?php $__tmp=array('modules/editor/skins/xpresseditor/js/xe_interface.js','','','');Context::loadFile($__tmp,'','','');unset($__tmp); ?><?php } ?>
	<?php if(!__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor/js/xpresseditor.min.js--><?php $__tmp=array('modules/editor/skins/xpresseditor/js/xpresseditor.min.js','','','');Context::loadFile($__tmp,'','','');unset($__tmp); ?><?php } ?>
    ...
    <div class="xpress-editor <?php echo $__Context->editor_class ?>">
		...
		<span class="input_auto xpress_xeditor_ui_editorresize"><input type="checkbox" id="editorresize"><label for="editorresize"><?php echo $__Context->lang->edit->edit_height_auto ?></label></span>
        </div>
