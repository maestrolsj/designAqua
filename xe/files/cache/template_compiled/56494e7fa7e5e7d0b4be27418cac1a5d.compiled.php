...
<div class="trackbackBox">
    ...
    <div class="trackbackUrl"><a name="trackback" href="<?php echo $__Context->oDocument->getTrackbackUrl() ?>" onclick="return false;"><?php echo $__Context->lang->trackback_url ?> : <?php echo $__Context->oDocument->getTrackbackUrl() ?></a><div class="clear"></div></div>
    ...
    <?php if($__Context->oDocument->getTrackbackCount()){ ?>
        ...
        <div class="trackbackItem">
            ...
            <address>
                ...
                <a href="<?php echo getUrl('act','dispBoardDeleteTrackback','trackback_srl',$__Context->val->trackback_srl) ?>"><img src="/xe/modules/board/skins/xe_board_extended/images/common/buttonDeleteX.gif" border="0" alt="delete" width="12" height="13" /></a>
                <span class="date">
