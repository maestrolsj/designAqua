<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/member/skins/default/js/member.js--><?php $__tmp=array('modules/member/skins/default/js/member.js','','','');Context::loadFile($__tmp,'','','');unset($__tmp); ?>
<!--#Meta:modules/member/skins/default/css/member.css--><?php $__tmp=array('modules/member/skins/default/css/member.css','','','');Context::loadFile($__tmp,'','','');unset($__tmp); ?>
<div class="xm">
