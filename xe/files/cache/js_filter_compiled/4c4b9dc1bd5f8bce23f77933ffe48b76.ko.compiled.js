function insert_document_module_config(form){ return legacy_filter('insert_document_module_config', form, 'document', 'procDocumentInsertModuleConfig', filterAlertMessage, ['error','message'], '등록하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["insert_document_module_config", {}]);
