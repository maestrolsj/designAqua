function insert_extra_var(form){ return legacy_filter('insert_extra_var', form, 'document', 'procDocumentAdminInsertExtraVar', completeInsertExtraVar, ['error','message'], '등록하시겠습니까?', {}) };
(function($){
	...
	v.cast('ADD_MESSAGE',['eid','확장변수 이름']);
