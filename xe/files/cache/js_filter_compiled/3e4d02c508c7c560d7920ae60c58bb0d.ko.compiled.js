function move_category(form){ return legacy_filter('move_category', form, 'document', 'procDocumentMoveCategory', completeMoveCategory, ['error','message','xml_file','source_category_srl'], '이동하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["move_category", {}]);
