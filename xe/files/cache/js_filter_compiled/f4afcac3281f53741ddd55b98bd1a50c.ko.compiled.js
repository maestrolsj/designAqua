function insert_point_module_config(form){ return legacy_filter('insert_point_module_config', form, 'point', 'procPointAdminInsertPointModuleConfig', filterAlertMessage, ['error','message'], '수정하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["insert_point_module_config", {}]);
