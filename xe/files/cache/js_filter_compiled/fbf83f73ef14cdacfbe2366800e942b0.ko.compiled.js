function delete_extra_var(form){ return legacy_filter('delete_extra_var', form, 'document', 'procDocumentAdminDeleteExtraVar', completeInsertExtraVar, ['error','message'], '삭제하시겠습니까?', {}) };
(function($){
