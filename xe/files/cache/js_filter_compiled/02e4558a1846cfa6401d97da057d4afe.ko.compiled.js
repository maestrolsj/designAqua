function delete_board(form){ return legacy_filter('delete_board', form, 'board', 'procBoardAdminDeleteBoard', completeDeleteBoard, ['error','message','page'], '', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["delete_board", {'module_srl': {required:true}}]);
