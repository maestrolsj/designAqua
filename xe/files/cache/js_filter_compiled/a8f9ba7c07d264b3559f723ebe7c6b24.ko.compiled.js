function insert_grant(form){ return legacy_filter('insert_grant', form, 'module', 'procModuleAdminInsertGrant', completeInsertGrant, ['error','message'], '등록하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["insert_grant", {'module_srl': {required:true,rule:'number'}}]);
