...
v.cast('ADD_FILTER',['insertRssModuleConfig', {'act':{required:true,default:'procRssAdminInsertModuleConfig'},'target_module_srl':{required:true},'open_rss':{required:true,rule:'open_type',default:'Y'},'open_total_feed':{required:true,rule:'total_type',default:'N'}}]);
v.cast('ADD_MESSAGE',['open_rss','피드(Feed) 공개']);
