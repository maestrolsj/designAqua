...
v.cast('ADD_FILTER',['insertJoinForm', {'column_type':{required:true},'column_name':{required:true,rule:'alpha_number'},'column_title':{required:true}}]);
v.cast('ADD_MESSAGE',['column_type','형식']);
v.cast('ADD_MESSAGE',['column_name','입력항목 이름']);
v.cast('ADD_MESSAGE',['column_title','입력항목 제목']);
