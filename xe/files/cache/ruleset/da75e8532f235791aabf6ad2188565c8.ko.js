...
v.cast('ADD_FILTER',['insertCategory', {'module_srl':{required:true,rule:'number'},'category_srl':{rule:'number'},'category_title':{required:true}}]);
v.cast('ADD_MESSAGE',['category_srl','분류']);
v.cast('ADD_MESSAGE',['category_title','분류 명']);
