...
v.cast('ADD_FILTER',['fileModuleConfig', {'allowed_filesize':{required:true,rule:'number',default:'2'},'allowed_attach_size':{required:true,rule:'number',default:'2'},'allowed_filetypes':{required:true,rule:'extension'}}]);
v.cast('ADD_MESSAGE',['allowed_filesize','파일 제한 크기']);
v.cast('ADD_MESSAGE',['allowed_attach_size','문서 첨부 제한']);
v.cast('ADD_MESSAGE',['allowed_filetypes','허용 확장자']);
