<html>
	...
	<body>
		<div id="page">
			<div id="container">
				<h1><a href="#">Cubicle</a></h1>
				<h4>A cubicle is a very small enclosed area, for example one where you can have a shower or change your clothes.</h4>
...
?>
						...
						<li>
								<a class="thumb" href="./cubicle/<? echo $file ?>" title="<?= $file ?>">
									<img src="./cubicle/<? echo $file ?>"  width="75" height="75" alt="<?= $file ?> " />
								</a>
								<div class="caption">
